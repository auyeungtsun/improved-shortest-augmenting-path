 ...
 */
bool has_feasible_flow(int n, int s, int t, const std::vector<OriginalEdge>& edges) {
...
void test_has_feasible_flow() {
    ...
    int s1 = 0;
    int t1 = 3;
    std::vector<OriginalEdge> edges1 = {
        {0, 1, 5, 10},
        {0, 2, 2, 8},
        {1, 3, 3, 6},
        {2, 3, 4, 9}
    ...
    int s2 = 0;
    int t2 = 2;
    std::vector<OriginalEdge> edges2 = {
        {0, 1, 5, 3},
        {1, 2, 1, 4},
    };
    ...
    int s3 = 0;
    int t3 = 3;
    std::vector<OriginalEdge> edges3 = {
    ...
    int s4 = 0;
    int t4 = 3;
    std::vector<OriginalEdge> edges4 = {
        {0, 1, 2, 5},
        {0, 2, 1, 3},
        {1, 3, 1, 3},
        {2, 3, 2, 4}
...
void run_has_feasible_flow_sample() {
    ...
    if(feasible){
        std::cout << "Sample has a feasible flow." << std::endl;
    }else{
        std::cout << "Sample does not have a feasible flow." << std::endl;
    }
}
